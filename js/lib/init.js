...
function initSound() {
	...
	var audio = {};
	var audioNames = ["fireball1", "fireball2", "gameover", "hit1", "hit2", "hit3", "hit4", "hit5", "hit6", "punch1", "punch2", "reset1", "reset2", "shield1", "shield2", "start", "walking1", "walking2"];
	var extensions = [".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav", ".wav"];
